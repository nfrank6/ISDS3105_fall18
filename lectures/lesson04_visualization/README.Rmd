...
#combine together geom_line() and geom_point() 
  ggplot() + geom_point(data = twitter_users, aes(x = Year, y = millions, color = 'gold'))+
  geom_line(data = twitter_users, aes(x = Year, y = millions, color = 'purple'))
...
#use sn_users to overlay a linechart of FB users over time
  ggplot() + geom_line(data = twitter_users, aes(x = Year, y = millions, color = 'twitter')) +
...
```{r}
ggplot()+
  geom_point(data = beerDt, aes(x=Year,y=gallons))+
  geom_line(data=beerDt, aes(x=year, y=gallons))
